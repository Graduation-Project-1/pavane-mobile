...
class AllProductReviewsScreen extends StatefulWidget {
  ...
  var product_id;
  AllProductReviewsScreen(this.product_id);

  @override
  State<AllProductReviewsScreen> createState() => _AllProductReviewsScreenState(product_id);
}

class _AllProductReviewsScreenState extends State<AllProductReviewsScreen> {

  var product_id;
  _AllProductReviewsScreenState(this.product_id);
  ...
  void _onRefresh() async {
    ...
    AppCubit.get(context).GetProductReviews(token: access_token, id: product_id, page: 1, size: 10);
  ...
  void _scrollListener() {
    if (scrollcontroller.position.pixels == scrollcontroller.position.maxScrollExtent) {
      if (page < totalPages) {
        ...
        page = page + 1;
        AppCubit.get(context).GetProductReviews(token: access_token, id: product_id, page: page, size: 10);
      }
    }
  }
